...
% *Default Spinach File*
% This file is included as a backup in case you want to revert to the original settings after 
% testing the updated Spinach files. It can also serve as a replacement if the default file 
% from the Spinach package is lost for any reason.
